...
#if !defined(RAD_GAMECUBE) && !defined(RAD_PS2) && !defined(RAD_PS3) && !defined(RAD_XBOX) && !defined(RAD_WIN32) && !defined(RAD_LINUX)
#error No platform defined (define one of RAD_GAMECUBE, RAD_PS2, RAD_PS3, RAD_XBOX, RAD_WIN32 or RAD_LINUX) 
#endif
