...
public:
    ...
    public:
        ...
        virtual void SetExpectedDimensions( int w, int h )      {;}
        virtual int  GetExpectedWidth()                          {return -1;}
        virtual int  GetExpectedHeight()                         {return -1;}
...
class tImageFactory
{
    public:
        ...
        void SetImageDimensions(int w, int h) { imgWidth = w; imgHeight = h; }
