...
; Input
;	v0		Position
;	v1		Blend Weight (3 explicit weights, 4th is implicit)
;	v2		Blend Indices
;	v3		Normal
;	v7		UV0
;------------------------------------------------------------------------------
...
; transform weighted joint 2 to camera space
dp4 r0.x, v0, c[a0.x + 17]
dp4 r0.y, v0, c[a0.x + 18]
dp4 r0.z, v0, c[a0.x + 19]
...
; transform weighted joint 3 to camera space
dp4 r0.x, v0, c[a0.x + 17]
dp4 r0.y, v0, c[a0.x + 18]
dp4 r0.z, v0, c[a0.x + 19]

; calculate weighting and sum using v1.z (3rd explicit weight)
mad r10, v1.z, r0, r10
...
; calculate weight 4 = 1 - weight[0] - weight[1] - weight[2]
add r0.x, v1.x, v1.y
add r0.x, r0.x, v1.z
sub r6.x, c0.y, r0.x

; transform weighted joint 4 to camera space
dp4 r0.x, v0, c[a0.x + 17]
dp4 r0.y, v0, c[a0.x + 18]
dp4 r0.z, v0, c[a0.x + 19]
