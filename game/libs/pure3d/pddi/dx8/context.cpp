...
public:
    ...
    void DrawSkin(pddiShader* shader, pddiPrimBuffer* skin)
    {
        ...
        int numPasses = material->GetPasses();
...
pddiExtension* d3dContext::GetExtension(unsigned extID)
{
    switch(extID)
    {
		case PDDI_EXT_HARDWARE_SKINNING:
			// Disable hardware skinning - use software skinning path instead
			// The hardware path has index-weight pairing issues causing missing heads/feet
			return NULL;
