...
enum pddiVertexMask
{
    ...
    PDDI_V_UVCOUNT8    = 8,
    PDDI_V_UVMASK      = 15,
    PDDI_V_UVSHIFT     = 0,  // UV count is in bits 0-3
...
enum pddiStatType
{
    ...
    PDDI_STAT_TRIS_DRAWN,
    PDDI_STAT_PRIM_DRAWN,
...
enum pddiBlendMode
{
    ...
    PDDI_BLEND_ONE,
    PDDI_BLEND_ZERO,
    PDDI_BLEND_SRCCOLOUR,
    PDDI_BLEND_INVSRCCOLOUR,
    PDDI_BLEND_SRCALPHA,
    PDDI_BLEND_INVSRCALPHA,
    PDDI_BLEND_INVDESTALPHA,
    PDDI_BLEND_DESTCOLOUR,
    PDDI_BLEND_INVDESTCOLOUR
};
