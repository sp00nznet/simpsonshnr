...
// Template function declarations - definitions after BaseBank class
template <class T> inline T* find(const BaseBank* bank, tUID uid);
template <class T> inline T* find(const BaseBank* bank, const char* name);
...
//---------------------------------------------------------------------------
// Template function definitions (after BaseBank is fully defined)
//---------------------------------------------------------------------------
