...
{
#ifdef DEBUGWATCH
	IRadDebugWatch* pWatch = radDebugWatchGet();
	if (pWatch != NULL) { pWatch->Delete( pValue ); }
#else
	(void) pValue;
#endif
}
...
#ifdef DEBUGWATCH
	IRadDebugWatch* pWatch = radDebugWatchGet();
	if (pWatch != NULL) { pWatch->AddUnsignedInt( pValue, pName, pNameSpace, callback, userData, min, max, readonly ); }
#else
...
#ifdef DEBUGWATCH
	IRadDebugWatch* pWatch = radDebugWatchGet();
	if (pWatch != NULL) { pWatch->AddInt( pValue, pName, pNameSpace, callback, userData, min, max, readonly ); }
#else
	(void) pValue; (void) pName; (void) pNameSpace; (void) min; (void) max; (void) callback; (void) userData; (void) readonly;
#endif
}
...
#ifdef DEBUGWATCH
	IRadDebugWatch* pWatch = radDebugWatchGet();
	if (pWatch != NULL) { pWatch->AddUnsignedShort( pValue, pName, pNameSpace, callback, userData, min, max, readonly ); }
#else
	(void) pValue; (void) pName; (void) pNameSpace; (void) min; (void) max; (void) callback; (void) userData; (void) readonly;
#endif
}
...
#ifdef DEBUGWATCH
	IRadDebugWatch* pWatch = radDebugWatchGet();
	if (pWatch != NULL) { pWatch->AddShort( pValue, pName, pNameSpace, callback, userData, min, max, readonly ); }
#else
	(void) pValue; (void) pName; (void) pNameSpace; (void) min; (void) max; (void) callback; (void) userData; (void) readonly;
#endif
}
...
#ifdef DEBUGWATCH
	IRadDebugWatch* pWatch = radDebugWatchGet();
	if (pWatch != NULL) { pWatch->AddUnsignedChar( pValue, pName, pNameSpace, callback, userData, min, max, readonly ); }
#else
	(void) pValue; (void) pName; (void) pNameSpace; (void) min; (void) max; (void) callback; (void) userData; (void) readonly;
#endif
}
...
#ifdef DEBUGWATCH
	IRadDebugWatch* pWatch = radDebugWatchGet();
	if (pWatch != NULL) { pWatch->AddChar( pValue, pName, pNameSpace, callback, userData, min, max, readonly ); }
#else
	(void) pValue; (void) pName; (void) pNameSpace; (void) min; (void) max; (void) callback; (void) userData; (void) readonly;
#endif
}
...
#ifdef DEBUGWATCH
	IRadDebugWatch* pWatch = radDebugWatchGet();
	if (pWatch != NULL) { pWatch->AddBoolean( pValue, pName, pNameSpace, callback, userData, readonly ); }
#else
...
#ifdef DEBUGWATCH
	IRadDebugWatch* pWatch = radDebugWatchGet();
	if (pWatch != NULL) { pWatch->AddFloat( pValue, pName, pNameSpace, callback, userData, min, max, readonly ); }
#else
	(void) pValue; (void) pName; (void) pNameSpace; (void) min; (void) max; (void) callback; (void) userData; (void) readonly;
#endif
}
...
#ifdef DEBUGWATCH
	IRadDebugWatch* pWatch = radDebugWatchGet();
	if (pWatch != NULL) { pWatch->AddString( pValue, stringLength, pName, pNameSpace, callback, userData, readonly ); }
#else
...
#ifdef DEBUGWATCH
	IRadDebugWatch* pWatch = radDebugWatchGet();
	if (pWatch != NULL) { pWatch->AddEnumeration( pValue, pEnumerationInfo, numberOfElements, pName, pNameSpace, callback, userData, readonly ); }
#else
...
#ifdef DEBUGWATCH
	IRadDebugWatch* pWatch = radDebugWatchGet();
	if (pWatch != NULL) { pWatch->AddVector( pValue, pName, pNameSpace, callback, userData, min, max, readonly ); }
#else
	(void) pValue; (void) pName; (void) pNameSpace; (void) min; (void) max; (void) callback; (void) userData; (void) readonly;
#endif
}
...
#ifdef DEBUGWATCH
	IRadDebugWatch* pWatch = radDebugWatchGet();
	if (pWatch != NULL) { pWatch->AddFunction( pName, pNameSpace, callback, userData ); }
#else
...
#ifdef DEBUGWATCH
	IRadDebugWatch* pWatch = radDebugWatchGet();
	if (pWatch != NULL) { pWatch->IssueHostRequest( Id, pData, length ); }
#else
...
#ifdef DEBUGWATCH
	IRadDebugWatch* pWatch = radDebugWatchGet();
	if (pWatch != NULL) { pWatch->AssociateFile( pNameSpace, pFilename, fileType ); }
#else
