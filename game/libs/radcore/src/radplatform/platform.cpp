...
class radPlatform : public IRadPlatform
{
    ...
    void Initialize( void )
    {
        ...
        // PS3 system initialization would go here
...
#ifdef RAD_PS3
//
// On the PS3, provide basic initialization.
// Two forms: simple and with IOP-compatible parameters (for source compatibility)
//
void radPlatformInitialize( void )
{
    pthePlatform = new( thePlaftormSpace ) radPlatform( );
    pthePlatform->Construct( RADMEMORY_ALLOC_DEFAULT );
    pthePlatform->Initialize();
}
