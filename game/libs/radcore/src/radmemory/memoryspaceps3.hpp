...
//=============================================================================
//
// File:        memoryspaceps3.hpp
//
// Subsystem:   Foundation Technologies - Memory Operation Services
//
// Description: This file contains the implementation of the PS3
//              remote memory space operations
//
//=============================================================================

#ifndef MEMORYSPACEPS3_HPP
#define MEMORYSPACEPS3_HPP
...
// is done all copies are synchronous on PS3.  There is only one of these
