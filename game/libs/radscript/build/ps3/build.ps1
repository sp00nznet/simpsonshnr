# radscript PS3 Build Script

$ErrorActionPreference = "Continue"

# Base paths (absolute)
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$RadscriptDir = (Resolve-Path "$ScriptDir\..\..").Path
$LibsDir = (Resolve-Path "$RadscriptDir\..").Path
$SourceDir = "$RadscriptDir\src"
$ObjDir = "$ScriptDir\Debug"
$LibOutDir = "$RadscriptDir\lib"
...
Write-Host "Building radscript for PS3"
...
$SourceFiles = @(
    ...
    "typeinfo/ps3/ps3typeinfovfcall"
)
...
@("factory", "namespace", "script", "typeinfo", "typeinfo/ps3", "typeinfoutil") | ForEach-Object {
    $subdir = "$ObjDir\$_"
    if (!(Test-Path $subdir)) {
...
$LibFile = "$LibOutDir\radscriptp3d.a"
