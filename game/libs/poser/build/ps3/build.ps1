# poser PS3 Build Script

$ErrorActionPreference = "Continue"

# Base paths (absolute)
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$PoserDir = (Resolve-Path "$ScriptDir\..\..").Path
$LibsDir = (Resolve-Path "$PoserDir\..").Path
$SourceDir = "$PoserDir\src"
$ObjDir = "$ScriptDir\Debug"
$LibOutDir = "$PoserDir\lib"
...
Write-Host "Building poser for PS3"
