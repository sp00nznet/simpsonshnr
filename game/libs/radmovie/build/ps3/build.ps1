# radmovie PS3 Build Script

$ErrorActionPreference = "Continue"

# Base paths (absolute)
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$RadmovieDir = (Resolve-Path "$ScriptDir\..\..").Path
$LibsDir = (Resolve-Path "$RadmovieDir\..").Path
$SourceDir = "$RadmovieDir\src"
$ObjDir = "$ScriptDir\Debug"
$LibOutDir = "$RadmovieDir\lib"
...
Write-Host "Building radmovie for PS3"
...
# Source files - PS3 stub only
$SourceFiles = @(
    "ps3/radmovie_ps3_stub"
)
...
$LibFile = "$LibOutDir\radmoviep3d.a"
