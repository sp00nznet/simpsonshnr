# radsound PS3 Build Script

$ErrorActionPreference = "Continue"

# Base paths (absolute)
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$RadsoundDir = (Resolve-Path "$ScriptDir\..\..").Path
$LibsDir = (Resolve-Path "$RadsoundDir\..").Path
$SourceDir = "$RadsoundDir\src"
$ObjDir = "$ScriptDir\Debug"
$LibOutDir = "$RadsoundDir\lib"
...
Write-Host "Building radsound for PS3"
...
$Includes = @(
    ...
    "-I$RadsoundDir\inc",
    "-I$RadsoundDir\src",
    "-I$RadsoundDir\src\common",
    "-I$RadsoundDir\src\hal\ps3",
    "-I$RadsoundDir\src\hal\common",
...
# Source files - PS3 standalone stub (all-in-one implementation)
$SourceFiles = @(
    "hal/ps3/radsound_ps3_stub"
)
...
$LibFile = "$LibOutDir\radsoundp3d.a"
