...
#include <stdio.h>
#include <sys/tty.h>
#define MCM_DEBUG(msg) { unsigned int _w; sys_tty_write(0, msg "\n", sizeof(msg), &_w); }
#else
#define MCM_DEBUG(msg)
#endif
...
{
    MCM_DEBUG("    MCM: about to new MemoryCardManager");
    spInstance = new MemoryCardManager;
    MCM_DEBUG("    MCM: new done");
    ...
    m_savedGameCreationSize( 0 )
{
    ...
    MCM_DEBUG("    MCM: constructor done");
