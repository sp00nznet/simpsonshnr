...
#else
    const float PedestrianManager::FADE_RADIUS = 75.0f; // in meters
    const float PedestrianManager::CENTER_OFFSET = 40.0f;  // in meters
    const float PedestrianManager::ADD_RADIUS = 60.0f;     // in meters
    const float PedestrianManager::REMOVE_RADIUS = 80.0f;  // in meters
    const float PedestrianManager::INITIAL_ADD_RADIUS = 100.0f; // in meters
#endif
