# Compile allworldsim.cpp for PS3
...
Write-Host "Compiling allworldsim.cpp..."

$srcPath = "..\..\code\worldsim\allworldsim.cpp"
$objPath = "Debug\allworldsim.o"

$cmdArgs = "$CXXFLAGS $INCLUDES -o $objPath $srcPath"
$process = Start-Process -FilePath $CXX -ArgumentList $cmdArgs -NoNewWindow -Wait -PassThru -RedirectStandardError "Debug\allworldsim.err"

if ($process.ExitCode -ne 0) {
    Write-Host "FAILED!" -ForegroundColor Red
    $errContent = Get-Content "Debug\allworldsim.err" -Raw
    if ($errContent) {
    ...
    Remove-Item "Debug\allworldsim.err" -ErrorAction SilentlyContinue
}
